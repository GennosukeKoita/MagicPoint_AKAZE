...
from utils.utils import saveImg, precisionRecall_torch, save_checkpoint
...
class Train_model_frontend(object):
    ...
    # propertyとsetterについて:https://qiita.com/cardene/items/8a59d576d360b7568c3a
    @property
    def writer(self):
        """
